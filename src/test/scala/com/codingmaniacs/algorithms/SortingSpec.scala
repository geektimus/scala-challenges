...
class SortingSpec extends Specification {
  ...
  "The bubble sort" should {
    "sort an empty array" in {
      val res = Sorting.bubbleSort(Array[Int]())
      res mustEqual Array[Int]()
    }
    "sort an array with one element" in {
      val arr = Array(100)
      val expected = Array(100)
      val res = Sorting.bubbleSort(arr)
      res mustEqual expected
    }
    "sort an array with two elements" in {
      val arr = Array(100, 10)
  ...
  "The insertion sort" should {
    "sort an empty array" in {
      val res = Sorting.insertionSort(Array[Int]())
      res mustEqual Array[Int]()
    }
    "sort an array with one element" in {
      val arr = Array(100)
      val expected = Array(100)
      val res = Sorting.insertionSort(arr)
      res mustEqual expected
    }
    "sort an array with two elements" in {
      val arr = Array(100, 10)
